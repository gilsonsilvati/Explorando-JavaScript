// Carrega depois da página html (DOM)
$(function() {
	var valorElement = $('#valor'); // jQuery
	var totalElement = document.getElementById('total'); // JavaScript
	...
	valorElement.on('keyup', function(e) {
		var total = 0;
		var valor = valorElement.maskMoney('unmasked')[0]; // Já devolve um float
